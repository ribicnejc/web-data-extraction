...
public class XPathParser {
    public static void main(String[] args) throws Exception {
        ...
        TagNode node2 = cleaner.clean(new File("input/avto.net/Mazda RX-7.html"), "Cp1252");
    ...
    private static void appendTitle(TagNode page, JSONObject json) {
        String title;
        try {
    ...
    private static void appendPrice(TagNode page, JSONObject json) {
        String price;
        try {
    ...
    private static void appendPhones(TagNode page, JSONObject json) {
    ...
    private static void appendData(TagNode page, JSONObject json) {
